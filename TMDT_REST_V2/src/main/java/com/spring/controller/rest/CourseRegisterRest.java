...
public class CourseRegisterRest {
	...
	@RequestMapping(value = "/user/course/register",method=RequestMethod.GET)
	...
	public ResponseEntity<?> getListCourseRegisterByUserID(HttpServletRequest request) {
		...
		List<CourseRegister> listCourseRegister = this.courseRegisterSerivce
				.getListCourseRegisterByUserID(user.getUserID());
