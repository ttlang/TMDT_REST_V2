...
INSERT INTO `nguoi_dung` VALUES ('ND1','Trương Tam Lang','2017-11-24 23:53:35','lang.tt16@gmail.com','https://drive.google.com/open?id=0B27mfRY62YKZRDNxWWZHdl9aUjA','$2a$10$XsFlD8/G1odLhxZNNSPrnue3pXMmwKPDwKvResVohO4AU0h34Lon6',0,1,'Đồng Tháp','01642222992'),('ND2','Nguyễn Tấn Phát','2017-11-24 23:53:35','cnttk40@gmail.com','https://drive.google.com/open?id=0B27mfRY62YKZRDNxWWZHdl9aUjA','$2a$10$7t0DI.Gs2rydJ6cSN7rb0u86WPAt67da6Q9Bs5Ns6.P2clHHwXOFK',0,1,'Bến Tre','01642222992'),('ND3','Trần Văn Thắng','2017-11-29 13:56:36','ttlang162@gmail.com','https://drive.google.com/open?id=0B27mfRY62YKZRDNxWWZHdl9aUjA','$2a$10$uSUPBtXdmcOkRanQ8g7rGemAFR1e12RYLoXcI9W40.gMzFbXoGljS',0,1,'Thủ Đức','01642222992'),('ND4','Nguyễn Tấn Phát','2017-11-29 13:56:36','ttlang163@gmail.com','https://drive.google.com/open?id=0B27mfRY62YKZRDNxWWZHdl9aUjA','$2a$10$oLJJJ44IPhPOSqZQd/a5cueZ8jY4IJs3.XUBERlV4ftZ5ziR3ipPO',0,0,'HCM','01642222992');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_paging_chu_de` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_paging_chu_de`(IN p_page_number integer,IN p_size integer,out p_sum_page integer)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_paging_query`(IN p_page_number integer,IN p_size integer,out p_sum_page integer,IN sql_query varchar(255))
begin
declare v_start integer;
declare v_end integer ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_paging_table`(IN p_page_number integer,IN p_size integer,out p_sum_page integer,IN p_table_name varchar(255))
begin
declare v_start integer;
declare v_end integer ;
declare v_total_item integer default 0;
